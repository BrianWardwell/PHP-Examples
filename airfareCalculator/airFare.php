...
<head>
	...
	<link rel="stylesheet" type="text/css" href="airfare_styles.css"><!--Link to main CSS styles -->
</head>
<body>

	<h1 class="header">AIR FARE CALCULATOR</h1>
	...
	?>
	</div><!---- end of .responseBody div--->
	<div class = "redirect">	
		<?php include 'redirect.php'; ?> <!-- Redirect include -->
	</div>
</body>
</html>
